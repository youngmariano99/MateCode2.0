...
export default function PlanificadorContenidoPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col gap-5 bg-[#111113] p-6 text-zinc-200">
      {/* Header section */}
          ...
          <div className="flex flex-col gap-4 md:col-span-6">
            <Card>
              ...
              <div className="flex flex-col gap-3">
                ...
                <Button onClick={handleSavePlan}>Guardar Planificación</Button>
              </div>
            </Card>
          </div>
              ...
              <div className="flex flex-col gap-4">
                        ...
                        return (
                          <button
                            ...
                            onClick={() =>
                              setContentCanales(
                                active
                                  ? contentCanales.filter((item) => item !== c)
                                  : [...contentCanales, c]
                              )
                            }
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <select
                      value={contentEstado}
                      onChange={(e) => setContentEstado(e.target.value as any)}
                      className="border-zinc-850 w-full rounded border bg-zinc-950 p-2 font-mono text-[10px] text-zinc-200 outline-none"
                    >
              ...
              <div className="border-zinc-850 grid grid-cols-2 gap-2 rounded-lg border bg-zinc-900 p-2.5">
                <div className="text-center">
                  ...
                  <span className="font-mono text-lg font-bold text-emerald-400">
                    {planContenidos.filter((c) => c.estado === "Subido").length}
                  </span>
                </div>
